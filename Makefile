#############################################################################
# Makefile for building: character
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  character.pro
# Template: app
# Command: /home/wyf/Qt5.9.2/5.9.2/gcc_64/bin/qmake -o Makefile character.pro
#############################################################################
...
INCPATH       = -I. -I../../../Qt5.9.2/5.9.2/gcc_64/include -I../../../Qt5.9.2/5.9.2/gcc_64/include/QtCore -I. -I../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/linux-g++
QMAKE         = /home/wyf/Qt5.9.2/5.9.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/wyf/Qt5.9.2/5.9.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/wyf/Qt5.9.2/5.9.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = character1.0.0
DISTDIR = /home/wyf/Desktop/qtproject/character/.tmp/character1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/wyf/Qt5.9.2/5.9.2/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/wyf/Qt5.9.2/5.9.2/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		character.pro character.h main.cpp \
		character.cpp
QMAKE_TARGET  = character
DESTDIR       = 
TARGET        = character
...
Makefile: character.pro ../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/common/unix.conf \
		../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/common/linux.conf \
		../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt5.9.2/5.9.2/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile character.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents character.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp character.cpp $(DISTDIR)/
...
main.o: main.cpp ../../../Qt5.9.2/5.9.2/gcc_64/include/QtCore/QCoreApplication \
